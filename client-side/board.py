...
game_objs.append(Button(map_x // 6 * 1, SCREEN_HEIGHT // 6 * 4, 100, 75, board_window).set_text("1").set_size(40).set_action(difficulty_choose, 0).set_id("difficulty_0"))
game_objs.append(Button(map_x // 6 * 2, SCREEN_HEIGHT // 6 * 4, 100, 75, board_window).set_text("2").set_size(40).set_action(difficulty_choose, 1).set_id("difficulty_1"))
game_objs.append(Button(map_x // 6 * 3, SCREEN_HEIGHT // 6 * 4, 100, 75, board_window).set_text("3").set_size(40).set_action(difficulty_choose, 2).set_id("difficulty_2"))
game_objs.append(Button(map_x // 6 * 4, SCREEN_HEIGHT // 6 * 4, 100, 75, board_window).set_text("4").set_size(40).set_action(difficulty_choose, 3).set_id("difficulty_3"))
game_objs.append(Button(map_x // 6 * 5, SCREEN_HEIGHT // 6 * 4, 100, 75, board_window).set_text("5").set_size(40).set_action(difficulty_choose, 4).set_id("difficulty_4"))
game_objs.append(Button(map_x // 6 * 1, SCREEN_HEIGHT // 6 * 5, 100, 75, board_window).set_text("6").set_size(40).set_action(difficulty_choose, 5).set_id("difficulty_5"))
game_objs.append(Button(map_x // 6 * 2, SCREEN_HEIGHT // 6 * 5, 100, 75, board_window).set_text("7").set_size(40).set_action(difficulty_choose, 6).set_id("difficulty_6"))
game_objs.append(Button(map_x // 6 * 3, SCREEN_HEIGHT // 6 * 5, 100, 75, board_window).set_text("8").set_size(40).set_action(difficulty_choose, 7).set_id("difficulty_7"))
game_objs.append(Button(map_x // 6 * 4, SCREEN_HEIGHT // 6 * 5, 100, 75, board_window).set_text("9").set_size(40).set_action(difficulty_choose, 8).set_id("difficulty_8"))
game_objs.append(Button(map_x // 6 * 5, SCREEN_HEIGHT // 6 * 5, 100, 75, board_window).set_text("10").set_size(40).set_action(difficulty_choose, 9).set_id("difficulty_9"))
